...
.esreg_twostep_covariance <- function(x, xq, xe, density, conditional_variance, alpha) {
    .Call('esreg_.esreg_twostep_covariance', PACKAGE = 'esreg', x, xq, xe, density, conditional_variance, alpha)
}
